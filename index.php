    ...
    <div class="starter-template">
        <div class="container">
            ...
            if (!isset($_GET['ico']) || $_GET['ico'] == "") {
                ...
                if ($contents2['are:Ares_odpovedi']['are:Odpoved']['dtt:Vysledek_hledani']['dtt:Kod'] == "2") {
                    echo ("<h3>Zadané IČO neexistuje v databázi</h3>");
                } else {
                    ...
                    if (isset($contents2['are:Ares_odpovedi']['are:Odpoved']['dtt:Vypis_RZP']['dtt:Osoby']['dtt:Osoba'])) {
